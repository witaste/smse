...
<body>
		...
		<form id="ff">
			<table>
				...
				<tr>
					...
					<td><input class="easyui-textbox" name="name" data-options="required:true,validType:['length[0,10]','notBlank']"></td>
				</tr>
				<tr>
					<td align="left">登录名:</td>
					<td><input class="easyui-textbox" name="username" data-options="iconCls:'icon-man',iconWidth:38,required:true,validType:['length[0,20]','notBlank']"></td>
				</tr>
				<tr>
					<td align="left">登录密码:</td>
					<td><input class="easyui-textbox" name="password" data-options="type:'password',iconCls:'icon-lock',iconWidth:38,required:true,validType:['length[0,20]','notBlank']"></td>
				</tr>
				<tr>
					<td align="left">手机号:</td>
					<td><input class="easyui-textbox" name="mobile" data-options="required:true,validType:['mobile']"></td>
				</tr>
				<tr>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() { 
			$('#ff').ajaxForm({
				type:'POST',
				url:'${baseUrl}system/saveUserAdd.json',
